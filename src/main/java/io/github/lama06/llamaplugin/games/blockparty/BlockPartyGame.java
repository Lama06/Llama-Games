...
import io.github.lama06.llamaplugin.util.MinecraftColor;
...
public class BlockPartyGame extends Game<BlockPartyGame, BlockPartyConfig> {
    ...
    public BlockPartyGame(GamesModule plugin, World world, BlockPartyConfig config, GameType<BlockPartyGame, BlockPartyConfig> type) {
    ...
    private void startRound(int round) {
        ...
        currentTask = Bukkit.getScheduler().runTaskLater(module.getPlugin(), () -> {
            removeFloorBlocks(type);

            currentTask = Bukkit.getScheduler().runTaskLater(module.getPlugin(), this::startNextRound, 40);
        }, roundTime);
    }
